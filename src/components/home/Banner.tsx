...
export default function Banner() {
    return (
        <div className="md:items-baseline items-center justify-center  flex md:grid grid-cols-12 grid-rows-5  flex-col md:flex-row w-full h-[380px] md:h-[400px] bg-gradient-to-r from-white to-sky-100">
            ...
            <div className="hidden col-span-4 col-start-8 row-span-4 row-start-2 md:flex">
